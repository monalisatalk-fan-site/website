...
export const LineStickers: React.VFC<Props> = ({
        ...
        <li key={sticker.id} className={styles.item}>
          <div className={styles.thumbnail}>
            <img
              ...
              src={`/images/top/stickers/${sticker.id}.png`}
            />
          </div>
          ...
          <div className={styles.author}>
            <a
              ...
              href={`https://store.line.me/stickershop/author/${author.id}`}
              target="_blank"
              rel="noreferrer"
            >
              {author.name}
          ...
          <a
            className={styles.link}
            href={`https://store.line.me/stickershop/product/${sticker.id}`}
            target="_blank"
            rel="noreferrer"
          >
