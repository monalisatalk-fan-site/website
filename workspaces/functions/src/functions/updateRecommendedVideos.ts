...
import { youtube, RECOMMENDED_VIDEOS_CHANNEL_ID, GCP_API_KEY } from '../helpers/fetchChannelVideos';

export const updateRecommendedVideos = functions.https.onRequest(async (req, res) => {
  if (req.method !== 'POST') {
    res.sendStatus(404);
